...
function App() {
  ...
  const [calculatedTotalInfinit, setCalculatedTotalInfinit] = useState("")
  ...
  const divide = (number) => {
   ...
   if(parseFloat(previousTotal) && parseFloat(number)) {
    let calculatedNumber = parseFloat(previousTotal) / parseFloat(number);
    setRunningTotal(calculatedNumber);
    setCalculatedTotal(calculatedNumber);
    setCalculatedTotalInfinit("")
      ...
      setCalculatedTotalInfinit("Can't divide with zero")
    }
  ...
  return (
    ...
    <div className="calculator">
      <div data-testid="running-total" id="running-total" className="display">{(calculatedTotalInfinit)? calculatedTotalInfinit :  runningTotal }</div>
      <KeyPad 
